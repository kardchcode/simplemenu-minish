...
void drawShadedSettingsOptionValueOnScreen(char *option, char *value, int position, int txtColor[], int txtBackgroundColor[]) {
	...
	drawShadedTextOnScreen(settingsfont, NULL, SCREEN_WIDTH-calculateProportionalSizeOrDistance(30)-retW3, position, value, txtColor, VAlignBottom | HAlignLeft, txtBackgroundColor);
}

void drawSettingsOptionValueOnScreen(char *value, int position, int txtColor[]) {
	int retW3=3;
	TTF_SizeText(settingsfont, (const char *) value, &retW3, NULL);
	drawTextOnScreen(settingsfont, NULL, SCREEN_WIDTH-calculateProportionalSizeOrDistance(30)-retW3, position, value, txtColor, VAlignBottom | HAlignLeft);
}

void drawShadedSettingsOptionOnScreen(char *option, int position, int txtColor[], int txtBackgroundColor[]) {
	int retW=1;
	TTF_SizeText(settingsfont, (const char *) option, &retW, NULL);
	drawShadedTextOnScreen(settingsfont, NULL, calculateProportionalSizeOrDistance(40), position, option, txtColor, VAlignBottom | HAlignLeft, txtBackgroundColor);
}

void drawNonShadedSettingsOptionOnScreen(char *buf, int position, int txtColor[]) {
	drawTextOnScreen(settingsfont, NULL, calculateProportionalSizeOrDistance(40), position, buf, txtColor, VAlignBottom | HAlignLeft);
}
...
void drawBigWhiteText(char *text) {
	...
	drawTextOnScreen(font, NULL, SCREEN_WIDTH/2, SCREEN_HEIGHT/2, text, white, VAlignMiddle | HAlignCenter);
}
